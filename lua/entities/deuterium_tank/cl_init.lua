include('shared.lua')
	...
	// Use this when you need to add to the rendering.
		...
		if ( LocalPlayer():GetEyeTrace().Entity == self.Entity && EyePos():Distance( self.Entity:GetPos() ) < 512 ) then
			AddWorldTip(self.Entity:EntIndex(),"Deuterium: "..tostring(self.Entity:GetNetworkedInt("deuterium",0)).." / "..tostring(self.Entity:GetNetworkedInt("maxdeuterium",0)),0.5,self.Entity:GetPos(),self.Entity)
		end
	end 