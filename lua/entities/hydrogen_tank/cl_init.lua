include('shared.lua')
	...
	// Use this when you need to add to the rendering.
		...
		if ( LocalPlayer():GetEyeTrace().Entity == self.Entity && EyePos():Distance( self.Entity:GetPos() ) < 512 ) then
			AddWorldTip(self.Entity:EntIndex(),"Hydrogen: "..tostring(self.Entity:GetNetworkedInt("water",0)).." / "..tostring(self.Entity:GetNetworkedInt("maxwater",0)),0.5,self.Entity:GetPos(),self.Entity)
		end
	end 