include('shared.lua')
	...
	// Use this when you need to add to the rendering.
		...
		if ( LocalPlayer():GetEyeTrace().Entity == self.Entity && EyePos():Distance( self.Entity:GetPos() ) < 512 ) then
			AddWorldTip(self.Entity:EntIndex(),"Energy: "..tostring(self.Entity:GetNetworkedInt("energy",0)).." / "..tostring(self.Entity:GetNetworkedInt("maxenergy",0)),0.5,self.Entity:GetPos(),self.Entity)
		end
	end 